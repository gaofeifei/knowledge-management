...
function left() {
    ...
    function territory(data) {
        if (data.event_num==0){
            $("#txtleft").html('<p style="width:550px;text-align:center;height: 500px;line-height:500px">无数据更新</p>');
        }else {
            var data=eval(data);
    ...
    function territory2(data) {
        if (data.event_num==0){
            $("#txtright").html('<p style="width:550px;text-align:center;height: 500px;line-height:500px">无数据更新</p>');
        }else {
            var data=eval(data);
